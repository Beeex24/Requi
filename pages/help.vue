...
const faqs = ref([
  ...
  },
  {
    ...
    answer: 'アカウント登録や作品閲覧は無料です。リクエストが成立した場合のみ、作品代金と手数料（5%固定（条件あり））をお支払いいただきます。'
  },
  {
    category: 'request',
  ...
  },
  {
    ...
    answer: '作品代金から手数料（5%固定（条件あり））を差し引いた金額が収益となります。条件を満たしていない事が発覚した場合は運営からご連絡の上、条件を満たしていただきます（※条件ですが、お持ちのSNSアカウントのプロフィール欄にリンクを貼っていただくことで５％の手数料が適用されます）'
  },
  {
    category: 'technical',
    question: 'ログインできません',
